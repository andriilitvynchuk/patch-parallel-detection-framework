...
class Buffer:
    ...
    def update(self, value: Any, not_full_return_value: Optional[Any] = None) -> Optional[Any]:
...
class TimeBuffer:
    ...
    def _choose_value(self) -> Any:
        return Counter([info_dict["value"] for info_dict in self._history]).most_common(1)[0][0]
